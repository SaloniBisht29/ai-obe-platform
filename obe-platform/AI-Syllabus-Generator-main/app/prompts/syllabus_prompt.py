...
def build_call2_prompt(
    ...
    # Unit theme guide — each unit gets a distinct progressive theme
    all_themes = [
        "UNIT 1 — Foundations & Introduction: history, terminology, definitions, classification, basic principles, mathematical foundations, notation",
        "UNIT 2 — Core Concepts & Mechanisms: key algorithms, data structures, standard methods, working principles, formal models, complexity analysis",
        "UNIT 3 — Advanced Techniques & Optimization: advanced algorithms, optimization strategies, performance analysis, theoretical depth, complexity trade-offs",
        "UNIT 4 — Applications & System Design: real-world systems, industry tools, implementation patterns, case studies, project design, integration",
        "UNIT 5 — Emerging Trends & Research Frontiers: current research, future directions, open problems, ethical considerations, recent innovations",
    ]
    theme_guide = "\n".join(all_themes[:num_units])
...
================================================================
1. EVERY unit MUST have a COMPLETELY DIFFERENT set of topics.
2. NO topic, concept, or keyword may appear in more than ONE unit.
3. Use only topics that belong to THAT unit's specific theme below.
4. Generic filler topics like 'introduction', 'overview', 'review' are FORBIDDEN in units 2-5.
5. Bloom's verbs must ESCALATE: Unit1=L1-L2, Unit2=L2-L3, Unit3=L3-L4, Unit4=L4-L5, Unit5=L5-L6.

UNIT THEME GUIDE — each unit covers ONLY its own theme:
{theme_guide}

Example of CORRECT unique titles for Data Mining:
  Unit 1: "Introduction to Data Mining and Knowledge Discovery"
  Unit 2: "Classification and Prediction Algorithms"
  Unit 3: "Clustering Methods and Association Rule Mining"
  Unit 4: "Mining Complex Data Types and Applications"
  Unit 5: "Advanced Mining: Deep Learning, Privacy and Ethics"

================================================================
YOUR TASK — Generate exactly {num_units} units for {course_name}.
================================================================

RULES FOR EACH UNIT:
- Each unit must have exactly 8 hours
- Minimum 12-15 specific subtopics per unit — ALL unique to that unit's theme
- topics_paragraph: comma-separated paragraph specific to this unit's theme, ending with (8 hours)
- unit_objectives: exactly 3 items with Bloom verb matching this unit's Bloom level range
- unit_outcomes: exactly 2 items mapped to COs (different COs for different units where possible)
- satisfied_cos: which COs this unit covers
- assessments: minimum 2 assessment items with marks
- readings: exactly 2 REAL book readings specific to this unit's topics
- lecture_plan: how 8 lectures cover this unit's topics
- STRICT JSON ONLY — no markdown, no explanation
...
{{
  "units": [
    {{
      "unit_id": "UNIT 1",
      "unit_title": "<UNIQUE TITLE — FOUNDATIONS THEME — specific to {course_name}>",
      "hours": 8,
      "satisfied_cos": ["CO1", "CO2"],
      "lecture_plan": "Lectures 1-2: <foundational topic A>. Lectures 3-5: <foundational topic B>. Lectures 6-7: <foundational topic C>. Lecture 8: Revision.",
      "topics_paragraph": "<12-15 subtopics from FOUNDATIONS THEME — comma-separated — specific to {course_name} Unit 1>. (8 hours)",
      "topics": ["<foundation subtopic 1>", "<foundation subtopic 2>", "... 12-15 total, all foundations-themed"],
      "unit_objectives": [
        "Remember (Bloom L1): Define key terms and list foundational concepts of {course_name}",
        "Understand (Bloom L2): Explain the origin, history and basic principles",
        "Apply (Bloom L3): Solve simple introductory problems using basic concepts"
      ],
      "unit_outcomes": [
        "Students will be able to define and explain foundational concepts of {course_name} (maps to CO1)",
        "Students will be able to apply basic principles to introductory problems (maps to CO2)"
      ],
      "assessments": [
        "Unit Test I — Questions from Unit 1 — CO1, CO2 (20 marks)",
        "Assignment I — Theory problems from Unit 1 — CO1 (5 marks)"
      ],
      "readings": [
        "Chapter X: <unit 1 specific topic> — <Real Author>, <Real Book>, <Publisher>, <Edition>, <Year>",
        "Chapter Y: <unit 1 specific topic> — <Real Author>, <Real Book>, <Publisher>, <Edition>, <Year>"
      ]
    }},
    {{
      "unit_id": "UNIT 2",
      "unit_title": "<UNIQUE TITLE — CORE CONCEPTS THEME — DIFFERENT from Unit 1>",
      "hours": 8,
      "satisfied_cos": ["CO2", "CO3"],
      "lecture_plan": "Lectures 1-2: <core topic A>. Lectures 3-5: <core topic B>. Lectures 6-7: <core topic C>. Lecture 8: Revision.",
      "topics_paragraph": "<12-15 subtopics from CORE CONCEPTS THEME — NO overlap with Unit 1>. (8 hours)",
      "topics": ["<core subtopic 1>", "... 12-15 total, all core-concepts-themed, ZERO overlap with Unit 1"],
      "unit_objectives": [
        "Understand (Bloom L2): Explain core mechanisms and models of {course_name}",
        "Apply (Bloom L3): Use standard algorithms and methods to solve problems",
        "Analyze (Bloom L4): Compare and contrast different core approaches"
      ],
      "unit_outcomes": [
        "Students will be able to explain and apply core concepts of {course_name} (maps to CO2)",
        "Students will be able to analyze standard methods and algorithms (maps to CO3)"
      ],
      "assessments": [
        "Unit Test I — Questions from Unit 2 — CO2, CO3 (20 marks)",
        "Assignment I — Analytical problems from Unit 2 — CO3 (5 marks)"
      ],
      "readings": [
        "Chapter X: <unit 2 specific topic> — <Real Author>, <Real Book>, <Publisher>, <Edition>, <Year>",
        "Chapter Y: <unit 2 specific topic> — <Real Author>, <Real Book>, <Publisher>, <Edition>, <Year>"
      ]
    }}
  ]
}}

REMINDER: Generate ALL {num_units} units. Each unit uses ONLY its own theme. ZERO topic overlap between units.

Generate exactly {num_units} detailed unique units for {course_name} now — STRICT JSON only:"""
